    ...
    return (
        <div style={{ width: '100%', maxWidth: '250px', backgroundColor: '#212529', color: '#fff', height: '100%', padding: '30px', boxShadow: '2px 0 5px rgba(0, 0, 0, 0.3)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                ...
                <Button onClick={toggleContent} style={{ marginTop: '20px', backgroundColor: '#444', border: 'none', padding: '10px 20px', borderRadius: '5px', cursor: 'pointer', transition: 'background-color 0.3s' }}>
                    Editar Perfil
                </Button>
            ...
            <Button style={{ marginTop: '20px', backgroundColor: '#444', border: 'none', padding: '10px 20px', borderRadius: '5px', cursor: 'pointer', transition: 'background-color 0.3s' }}>
                Cambiar Contraseña
            </Button>
            <Button style={{ marginTop: '20px', backgroundColor: '#444', border: 'none', padding: '10px 20px', borderRadius: '5px', cursor: 'pointer', transition: 'background-color 0.3s' }}>
                Calendario
